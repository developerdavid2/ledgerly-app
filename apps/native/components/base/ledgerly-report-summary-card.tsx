...
export default function LedgerlyReportSummaryCard({
  ...
  return (
    ...
    >
      <Card
        className="flex-1 flex-col items-start bg-brand-white/60 dark:bg-accent-card/15 rounded-2xl py-5 px-4 gap-y-3 border-0"
        style={[{ borderCurve: "continuous" }, shadowStyle]}
      >
        {/* Icon Circle */}
        <View className="w-10 h-10 rounded-[25px] bg-brand-flashwhite dark:bg-brand-green-800 items-center justify-center">
          <View
            style={
              type === "income"
          ...
          >
            <GeneralArrowUpRi color={iconColor} width={20} height={20} />
          </View>
        </View>

        <Card.Body className="flex-col items-start gap-y-1 p-0">
          <Card.Description
            className="text-sm leading-3.75 text-brand-black dark:text-brand-white text-center"
          ...
          <Card.Title
            className="text-[16px] leading-5.5 text-brand-black dark:text-brand-white text-center"
      ...
      >
        {/* Icon Circle */}
        <View className="w-10 h-10 rounded-[25px] bg-brand-flashwhite dark:bg-brand-green-800 items-center justify-center">
          <GeneralWallet color={iconColor} width={20} height={20} />
        </View>
