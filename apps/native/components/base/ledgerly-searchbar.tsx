...
export default function LedgerlySearchbar({
  ...
  return (
    ...
    >
      <SearchField.Group className="flex-row items-center w-full h-15 bg-white dark:bg-dark-charcoal-green rounded-3xl px-6">
        <SearchField.Input
          className="flex-1 text-[16px] text-brand-black dark:text-brand-white pr-3 bg-transparent border-0 h-full mr-4"
