...
export default function LedgerlyNotificationCard({
  ...
  return (
    <TouchableOpacity
      className="flex-row items-center justify-between w-full bg-brand-white dark:bg-dark-charcoal-green rounded-2xl p-4 mb-2.5"
      style={{
    ...
    >
      <View className="flex-row items-center gap-x-3 flex-1">
        ...
        {/* Icon Container */}
        <View className="w-12.5 h-12.5 rounded-[40px] items-center justify-center bg-dark-green/50">
          {icon}
        </View>
