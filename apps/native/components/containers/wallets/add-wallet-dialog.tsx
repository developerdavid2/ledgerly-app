      ...
      <BottomSheet.Portal>
        ...
        >
          ...
          <View className="flex-col gap-y-4 mb-6">
            ...
            <View className="flex-row items-center justify-between h-17.5 px-6 rounded-full g-brand-flashwhite dark:bg-accent/10">
              <Text
              ...
              <RadioGroup.Item
                ...
                className={`flex-row h-14 px-5 rounded-[28px] items-center justify-between w-[48%] ${
                  type === t.value
                    ...
                    : "bg-brand-flashwhite dark:bg-accent/10"
                }`}
              >
                <View className="flex-row items-center gap-x-2">
                  <Ionicons
                    name={t.icon as any}
                    size={18}
                    color={type === t.value ? themeColorForeground : "#888888"}
                  />
                  <Text
