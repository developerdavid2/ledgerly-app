      ...
      <BottomSheet.Portal>
        ...
        >
          ...
          <View className="flex-row items-center gap-x-2.5 mb-6">
            <View className="flex-row items-center">
              <TouchableOpacity
                ...
                className="w-12.5 h-12.5 rounded-[40px] items-center justify-center bg-brand-white dark:bg-accent-card"
              >
                <StyledGeneralOption
          ...
          <View className="flex-row gap-x-4 mb-8">
            <TouchableOpacity className="w-17.5 h-17.5 rounded-full bg-brand-flashwhite dark:bg-accent/10 items-center justify-center shrink-0">
              <Text className="text-2xl">{emoji}</Text>
            </TouchableOpacity>
            <TextField className="flex-1">
              <InputGroup className="w-full h-17.5 rounded-full bg-brand-flashwhite dark:bg-accent/10 overflow-hidden">
                <InputGroup.Input
                  value={name}
          ...
          >
            ...
            >
              <View className="flex-row items-center gap-x-2.5">
                <View className="w-12.5 h-12.5 rounded-[40px] items-center justify-center bg-brand-white dark:bg-muted/15">
                  <StyledGeneralEdit
                    color={themeColorForeground}
                    width={24}
                    height={24}
